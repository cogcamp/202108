...
mainScene.createPaddle=function(){
    ...
    thispaddle.isStart=true:
    this.physics.add.collider(this.paddle, this.ball, this.hitPaddle, null, this);
    
    //キーボードのカーソルオブジェクトを取得
    var cursors=this.iput.keyboard.createCursorKeys();
    var x=0;
    
    //右カーソルをクリックすると
if(cursors.rightisDown){
